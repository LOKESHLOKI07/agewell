...
AGEWELL_SERVICES: list[ServiceInfo] = [
    ...
    },
    {
        ...
        "description": "Nutrition guidance tailored to your health needs.",
        "href": "/membership/personalised-diet-plan",
        "bookable": True,
        "keywords": ("diet plan", "nutrition", "personalised diet", "meal plan", "diet"),
    },
    {
        "slug": "grocery",
...
HREF_ALIASES: dict[str, str] = {
    ...
    "orders": "/(tabs)/orders",
    "/membership/home-inspection": "/membership/personalised-diet-plan",
    "home inspection": "/membership/personalised-diet-plan",
}
